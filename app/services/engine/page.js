                ...
                <div className="container mx-auto px-4 relative z-10 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                        ...
                        <div className="space-y-2">
                            <p className="text-primary font-semibold uppercase tracking-wider text-sm font-sans">Advanced Computer Diagnostics</p>
                            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground">Engine Diagnostics</h1>
                        </div>
                    </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 bg-gray-400 overflow-hidden">
                <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-lg md:text-xl font-serif">
                        Our advanced engine diagnostics service uses the latest computer scanning technology to pinpoint issues with precision. Whether your check engine light is on, you're experiencing performance problems, or you want a comprehensive health check, our diagnostic equipment reads fault codes and sensor data to identify the root cause. This ensures accurate repairs and prevents unnecessary part replacements.</p>
                </div>
                ...
                <div className="px-4 py-6 bg-white/55 rounded-lg space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-3 text-black font-serif">
                        <li className="leading-relaxed text-lg text-muted-foreground">
                            Connect advanced OBD-II scanners to read engine fault codes and live data
                        </li>
                        <li className="leading-relaxed text-lg text-muted-foreground">
                            Read and analyze fault codes to identify specific engine issues and affected systems
                        </li>
                        <li className="leading-relaxed text-lg text-muted-foreground">
                            Live data monitoring to assess sensor performance and engine conditions in real-time
                        </li>
                        <li className="leading-relaxed text-lg text-muted-foreground">
                            Visual inspection of engine components for signs of wear, leaks, or damage
                        </li>
                        <li className="leading-relaxed text-lg text-muted-foreground">
                            Detailed diagnostic report with recommended repairs and maintenance to restore optimal engine performance
                        </li>
                    </ol>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Our advanced engine diagnostics service uses the latest computer scanning technology to pinpoint issues with precision.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Accurate diagnostics prevent unnecessary part replacements and reduce labor costs.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Most diagnostics can be completed within an hour, allowing for faster repairs and less downtime.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Receive a comprehensive report of your vehicle's health.
                        </p>
                    </div>
