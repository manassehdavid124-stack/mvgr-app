                ...
                <div className="container mx-auto px-4 relative z-10 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                        ...
                        <div className="space-y-2">
                            <p className="text-primary font-semibold uppercase tracking-wider text-sm font-sans">Complete Engine & Transmission Solutions</p>
                            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground">Mechanical Repairs</h1>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Our team consists of factory-trained mechanical engineers with years of experience.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border p-8 shadow-sm">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            We use only high-quality OEM and trusted aftermarket parts for lasting repairs.
                        </p>
                    </div>
