    ...
    return (
        <div className="font-serif min-h-screen">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/30 shadow-sm flex items-center h-16 px-3 sm:px-8 md:px-10 lg:px-32">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-red-600 font-bold font-sans text-2xl sm:text-3xl">MVGR</div>
                    <div className="text-black font-bold leading-tight text-xs font-sans">
                        MIGHTY VESSELS <br /> GLOBAL RESOURCES
                    </div>
                </div>

                <div className="ml-auto hidden text-black/70 lg:flex items-center gap-4 font-bold">
                    <Link href="/" className="px-3 py-2 rounded-xl hover:text-red-500 font-sans">HOME</Link>
                    <Link href="/#about" className="px-3 py-2 rounded-xl hover:text-red-500 font-sans">ABOUT</Link>
                    <Link href="/#services" className="px-3 py-2 rounded-xl hover:text-red-500 font-sans">SERVICES</Link>
                    <Link href="/#contact" className="px-3 py-2 rounded-xl hover:text-red-500 font-sans">CONTACT</Link>

                    <Link href="/book" className="px-4 py-2 bg-red-500 text-white rounded-xl hover:bg-red-600">
                        Book a Repair
                    </Link>
                </div>
                ...
                {open && (
                    <div className="absolute top-16 left-0 right-0 bg-white/80 backdrop-blur-xl flex flex-col gap-4 py-4 px-6 border-t">

                        <Link href="/" className="py-2 hover:text-red-500">HOME</Link>
                        <Link href="/#about" className="py-2 hover:text-red-500">ABOUT</Link>
                        <Link href="/#services" className="py-2 hover:text-red-500">SERVICES</Link>
                        <Link href="/#contact" className="py-2 hover:text-red-500">CONTACT</Link>

                        <Link href="/book" className="py-3 bg-red-500 text-white rounded-xl text-center">
                            Book a Repair
                        </Link>
            ...
            <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 space-y-6">
                    ...
                    <Link href="/#services" className="inline-flex items-center text-black/70 hover:text-red-500">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div>
                            <p className="text-red-500 uppercase text-sm">Complete Engine Solutions</p>
                            <h1 className="text-4xl text-black/70 md:text-6xl font-bold">Mechanical Repairs</h1>
                        </div>
                    </div>

                    <p className="text-gray-600 max-w-2xl">
                        Complete engine overhauls, transmission repairs, and general mechanical work by certified engineers.
                    </p>
            ...
            <section className="bg-white py-10 text-center">
                ...
                <h2 className="text-4xl font-light text-black/70 mb-6">GALLERY</h2>

                <div className="grid md:grid-cols-3 gap-6 px-6">

                    <Image src="/img/mechanic-4.jpg" width={500} height={400} className="rounded-xl shadow hover:scale-105 transition" alt="" />
                    <Image src="/img/mechanic-2.jpeg" width={500} height={400} className="rounded-xl shadow hover:scale-105 transition" alt="" />
                    <Image src="/img/mechanic-3.jpeg" width={500} height={400} className="rounded-xl shadow hover:scale-105 transition" alt="" />
            ...
            <section className="relative grid md:grid-cols-2 gap-8 p-10 overflow-hidden">
                ...
                <div>
                    <h1 className="text-red-500 text-xl">ABOUT THIS SERVICE</h1>
                    <h2 className="text-2xl font-light text-black">WHAT WE OFFER</h2>
                ...
                <div className="bg-white/40 backdrop-blur-xl border p-6 rounded-xl shadow">
                    <h2 className="text-xl font-semibold text-black/70 mb-4">What to Expect</h2>
            ...
            <section className="py-20 px-6 text-center bg-white overflow-hidden">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    {[1,2,3,4].map((i)=>(
                        <div key={i} className="bg-black/30 backdrop-blur-xl border p-6 rounded-xl shadow hover:scale-105 transition">
                            <CheckCircle className="text-red-500 mb-3" />
                            <h3 className="font-semibold">Quality Service</h3>
                            <p className="text-gray-600 text-sm">Top tier repair and service</p>
                        </div>
                    ))}
            ...
            {/* FOOTER */}
            <footer className="relative py-8 text-center overflow-hidden text-black/70">
